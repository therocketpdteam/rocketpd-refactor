...
function rocketpd_get_cohorts() {
	...
	return array(
		...
		array(
			...
			'cohort_subtitle'          => __( 'A five-session cohort with Drs. Luvelle Brown and Shelley Berman on leading with courage in the face of rising attacks on public education.', 'rocketpd' ),
			'cohort_short_description' => __( 'Join award-winning superintendents Drs. Luvelle Brown and Shelley Berman for a five-session cohort on leading with courage in the face of rising attacks on K-12 public education.', 'rocketpd' ),
			'cohort_topic'             => __( 'School Culture', 'rocketpd' ),
			'cohort_audience'          => array( __( 'Superintendents', 'rocketpd' ), __( 'Assistant Superintendents', 'rocketpd' ), __( 'Central-Office Teams', 'rocketpd' ), __( 'Building Teams', 'rocketpd' ), __( 'School Board Members', 'rocketpd' ) ),
