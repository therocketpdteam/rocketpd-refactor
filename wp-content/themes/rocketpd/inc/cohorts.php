...
function rocketpd_get_cohorts() {
	...
	return array(
		...
		array(
			...
			'title'                    => __( 'Redesigning Instruction: A Three-Step Process to Meet Every Learner\'s Needs', 'rocketpd' ),
			'cohort_subtitle'          => __( 'Master classroom-tested techniques that help all students - and their teachers - succeed.', 'rocketpd' ),
			'cohort_short_description' => __( 'Join Robert Barnett for five live sessions on redesigning instruction through blended, self-paced, and mastery-based learning.', 'rocketpd' ),
			'cohort_topic'             => __( 'Individualized Instruction', 'rocketpd' ),
			'cohort_audience'          => array( __( 'Classroom Teachers', 'rocketpd' ), __( 'Instructional Coaches', 'rocketpd' ), __( 'Principals', 'rocketpd' ), __( 'District Administrators', 'rocketpd' ) ),
			'cohort_status'            => 'closed',
			'featured_toggle'          => false,
			...
			'price_amount'             => 495,
			'instructor'               => array(
				'name'     => __( 'Robert Barnett', 'rocketpd' ),
				'title'    => __( 'Co-Founder, Modern Classrooms Project', 'rocketpd' ),
				'headshot' => '/wp-content/uploads/2025/03/robert-barnett-modern-classrooms-project-1-2-2.png',
			),
			'card_image'               => '/wp-content/uploads/2025/03/robert-barnett-modern-classrooms-project-1-2-2.png',
			'sponsor_enabled'          => true,
			'sponsor_name'             => __( 'Modern Classrooms Project', 'rocketpd' ),
			'href'                     => home_url( '/cohorts/redesigning-instruction-a-three-step-process-to-meet-every-learners-needs/' ),
		),
		array(
			'slug'                     => 'retain-teachers-improve-learning-through-innovative-personalized-professional-development-with-george-couros',
			'title'                    => __( 'Igniting Passion: Retain Teachers &amp; Improve Learning Through Innovative &amp; Personalized Professional Development', 'rocketpd' ),
			'cohort_subtitle'          => __( 'Design professional learning experiences that energize educators and strengthen school culture.', 'rocketpd' ),
			'cohort_short_description' => __( 'Join George Couros for five live sessions on creating innovative professional learning that supports staff engagement, retention, and student outcomes.', 'rocketpd' ),
			'cohort_topic'             => __( 'Staff Engagement', 'rocketpd' ),
			'cohort_audience'          => array( __( 'PD Coordinators', 'rocketpd' ), __( 'Instructional Trainers', 'rocketpd' ), __( 'Team Leaders', 'rocketpd' ), __( 'Classroom Teachers', 'rocketpd' ) ),
			'cohort_status'            => 'closed',
			'featured_toggle'          => false,
			...
			'instructor'               => array(
				...
				'title'    => __( 'Author, Speaker &#183; Innovation Leader', 'rocketpd' ),
				'headshot' => '/wp-content/uploads/2024/03/George-Couros.jpg',
			),
			'card_image'               => '/wp-content/uploads/2024/03/George-Couros.jpg',
			'sponsor_enabled'          => false,
			'sponsor_name'             => '',
			'href'                     => home_url( '/cohorts/retain-teachers-improve-learning-through-innovative-personalized-professional-development-with-george-couros/' ),
		),
		array(
			'slug'                     => 'tech-like-a-pirate-how-to-create-a-buzzworthy-classroom-that-captures-students-attention-and-holds-it',
			'title'                    => __( 'Tech Like a Pirate: How to Create a Buzzworthy Classroom That Captures Students\' Attention and Holds It', 'rocketpd' ),
			'cohort_subtitle'          => __( 'Create technology-powered learning experiences that capture students\' attention and keep it.', 'rocketpd' ),
			'cohort_short_description' => __( 'Join Matt Miller for five live sessions on using technology, media, games, and student interests to make learning more engaging and memorable.', 'rocketpd' ),
			'cohort_topic'             => __( 'Instructional Design', 'rocketpd' ),
			'cohort_audience'          => array( __( 'K-12 Teachers', 'rocketpd' ), __( 'Instructional Coaches', 'rocketpd' ), __( 'Technology Coaches', 'rocketpd' ), __( 'Curriculum Directors', 'rocketpd' ) ),
			'cohort_status'            => 'closed',
			'featured_toggle'          => false,
			'start_date'               => '2025-11-05',
			'end_date'                 => '2025-12-10',
			...
			'instructor'               => array(
				...
				'title'    => __( 'Author, Tech Like a PIRATE &#183; Founder, Ditch That Textbook', 'rocketpd' ),
				'headshot' => '/wp-content/uploads/2025/03/matt-miller-tech-like-a-pirate.jpg',
			),
			'card_image'               => '/wp-content/uploads/2025/03/matt-miller-tech-like-a-pirate.jpg',
			'sponsor_enabled'          => false,
			'sponsor_name'             => '',
			'href'                     => home_url( '/cohorts/tech-like-a-pirate-how-to-create-a-buzzworthy-classroom-that-captures-students-attention-and-holds-it/' ),
		),
		array(
			'slug'                     => 'unlocking-teacher-productivity-with-angela-watson',
			'title'                    => __( 'Unlocking Teacher Productivity', 'rocketpd' ),
			'cohort_subtitle'          => __( 'A process to help prioritize, organize, and find your flow.', 'rocketpd' ),
			'cohort_short_description' => __( 'Join Angela Watson for five live sessions on streamlining teacher workload, reclaiming time, and reducing overwhelm.', 'rocketpd' ),
			'cohort_topic'             => __( 'Time Management', 'rocketpd' ),
			'cohort_audience'          => array( __( 'K-12 Teachers', 'rocketpd' ), __( 'Instructional Coaches', 'rocketpd' ), __( 'District Leaders', 'rocketpd' ), __( 'New Teachers', 'rocketpd' ) ),
			'cohort_status'            => 'closed',
			'featured_toggle'          => false,
			...
			'instructor'               => array(
				...
				'title'    => __( 'Founder, Truth for Teachers &#183; Productivity Specialist', 'rocketpd' ),
				'headshot' => '/wp-content/uploads/2025/01/angela-watson-truth-for-teachers.jpeg',
			),
			'card_image'               => '/wp-content/uploads/2025/01/angela-watson-truth-for-teachers.jpeg',
			'sponsor_enabled'          => false,
			'sponsor_name'             => '',
			'href'                     => home_url( '/cohorts/unlocking-teacher-productivity-with-angela-watson/' ),
		),
		array(
			'slug'                     => 'using-family-engagement-to-solve-real-problems-in-k-12-schools',
			'title'                    => __( 'Using Family Engagement to Solve Real Problems in K-12 Schools', 'rocketpd' ),
			'cohort_subtitle'          => __( 'Deploy Five Simple Principles to fight chronic absenteeism and improve student outcomes.', 'rocketpd' ),
			'cohort_short_description' => __( 'Join Drs. Steve and Peggie Constantino for five live sessions on applying family engagement to urgent K-12 challenges.', 'rocketpd' ),
			'cohort_topic'             => __( 'Family Engagement', 'rocketpd' ),
			'cohort_audience'          => array( __( 'Superintendents', 'rocketpd' ), __( 'Program Directors', 'rocketpd' ), __( 'Family Support Specialists', 'rocketpd' ), __( 'Site Administrators', 'rocketpd' ) ),
			'cohort_status'            => 'closed',
			'featured_toggle'          => false,
			...
			'price_amount'             => 495,
			'instructor'               => array(
				'name'     => __( 'Dr. Steve Constantino', 'rocketpd' ),
				'title'    => __( 'Family Engagement Expert &#183; With Dr. Peggie Constantino', 'rocketpd' ),
				'headshot' => '/wp-content/uploads/2024/04/dr-steve-constantino-rocketpd-instructor-family-engagement.jpg',
			),
			'card_image'               => '/wp-content/uploads/2024/04/dr-steve-constantino-rocketpd-instructor-family-engagement.jpg',
			'sponsor_enabled'          => false,
			'sponsor_name'             => '',
			'href'                     => home_url( '/cohorts/using-family-engagement-to-solve-real-problems-in-k-12-schools/' ),
		),
	);
}
