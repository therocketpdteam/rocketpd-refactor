...
$cards = array(
	array( 'icon' => 'bulb', 'title' => __( 'Learn from trusted K-12 experts', 'rocketpd' ), 'body' => __( 'Cohorts are led by nationally recognized authors, researchers, and practitioners.', 'rocketpd' ) ),
	array( 'icon' => 'target', 'title' => __( 'Apply between sessions', 'rocketpd' ), 'body' => __( 'Each session ends with a practical action - not a homework worksheet.', 'rocketpd' ) ),
	array( 'icon' => 'chat', 'title' => __( 'Collaborate with peers', 'rocketpd' ), 'body' => __( 'Small-group breakouts and async discussion connect you to educators solving the same problems.', 'rocketpd' ) ),
		...
		<div class="rpd-cohorts-value-grid">
			<?php foreach ( $cards as $card ) : ?>
				<article class="rpd-cohorts-value-card">
					<span aria-hidden="true"><?php echo rocketpd_topic_icon_svg( $card['icon'], 'rpd-cohorts-icon' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></span>
