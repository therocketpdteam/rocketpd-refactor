...
<section class="rpd-topics-opportunities rpd-topics-section">
	<div class="rpd-container">
		<header class="rpd-topics-section__header">
			<p class="rpd-topics-kicker"><?php esc_html_e( 'Upcoming Learning Opportunities', 'rocketpd' ); ?></p>
		...
		<div class="rpd-topics-opportunity-grid">
			<?php foreach ( $opportunities as $opportunity ) : ?>
				<?php $icon = false !== strpos( $opportunity['format'], 'Webinar' ) ? 'webinar' : ( false !== strpos( $opportunity['format'], 'Cohort' ) ? 'calendar' : 'screen' ); ?>
