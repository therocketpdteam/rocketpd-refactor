...
<section class="rpd-lpp-experiences rpd-lpp-section rpd-lpp-dark">
	<div class="rpd-container">
		<header class="rpd-lpp-section-header rpd-lpp-section-header--center">
			<p class="rpd-lpp-eyebrow"><?php echo esc_html( rocketpd_get_field( 'rpd_lpp_experiences_eyebrow', __( 'Beyond the Platform', 'rocketpd' ) ) ); ?></p>
			<h2><?php echo esc_html( rocketpd_get_field( 'rpd_lpp_experiences_headline', __( 'Connected to RocketPD Learning Experiences.', 'rocketpd' ) ) ); ?></h2>
			<p><?php echo esc_html( rocketpd_get_field( 'rpd_lpp_experiences_intro', __( "LaunchPad+ extends access to RocketPD's broader learning ecosystem.", 'rocketpd' ) ) ); ?></p>
		</header>
		...
		<p class="rpd-lpp-centered-note rpd-lpp-centered-note--dark rpd-lpp-centered-note--italic"><?php echo esc_html( rocketpd_get_field( 'rpd_lpp_experiences_closing', __( 'These experiences complement the platform and extend learning beyond asynchronous content.', 'rocketpd' ) ) ); ?></p>
	</div>
</section>
