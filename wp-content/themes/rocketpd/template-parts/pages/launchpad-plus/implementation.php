...
<section class="rpd-lpp-implementation rpd-lpp-section">
	<div class="rpd-container">
		...
		<p class="rpd-lpp-centered-note rpd-lpp-centered-note--italic"><?php echo esc_html( rocketpd_lpp_get_field( 'rpd_lpp_implementation_closing', __( 'Rather than relying on one-time sessions, districts can build a more consistent approach to educator development.', 'rocketpd' ) ) ); ?></p>
	</div>
</section>
