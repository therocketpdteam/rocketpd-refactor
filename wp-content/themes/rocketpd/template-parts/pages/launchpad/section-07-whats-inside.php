...
$mode = rocketpd_lp_get_field( 'lp_inside_mode', 'defaults' );
if ( 'hidden' === $mode ) {
	return;
}

$default_eyebrow = __( "What's Inside", 'rocketpd' );
$default_h2      = __( 'What Districts Get with LaunchPad.', 'rocketpd' );
$default_cards   = array(
...
if ( 'custom' === $mode ) {
	$eyebrow   = rocketpd_lp_get_field( 'inside_eyebrow', $default_eyebrow );
	$h2        = rocketpd_lp_get_field( 'inside_h2', $default_h2 );
	$acf_cards = rocketpd_lp_get_field( 'inside_cards', null );
...
<section class="rpd-lp-section rpd-lp-inside">
	<div class="rpd-container">
		<header class="rpd-lp-section-header rpd-lp-section-header--center"><p class="rpd-lp-eyebrow"><?php echo esc_html( $eyebrow ); ?></p><h2><?php echo esc_html( $h2 ); ?></h2></header>
