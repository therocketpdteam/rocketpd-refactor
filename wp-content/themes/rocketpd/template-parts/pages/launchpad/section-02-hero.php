...
$primary = rocketpd_lp_get_field( 'hero_cta_primary', array( 'title' => __( 'Explore LaunchPad', 'rocketpd' ), 'url' => '#explore' ) );
$secondary = rocketpd_lp_get_field( 'hero_cta_secondary', array( 'title' => __( 'See It In Action', 'rocketpd' ), 'url' => '#launchpad-demo' ) );
$image = rocketpd_lp_image_url( rocketpd_lp_get_field( 'hero_image', '' ), rocketpd_lp_asset( 'teacher-1.jpg' ) );
?>
...
<section class="rpd-lp-hero">
	...
	<div class="rpd-container rpd-lp-hero__grid">
		<div class="rpd-lp-hero__copy">
			<p class="rpd-lp-pill rpd-lp-pill--gold"><?php rocketpd_lp_icon( 'zap' ); ?><?php echo esc_html( rocketpd_lp_get_field( 'hero_eyebrow', __( 'RocketPD LaunchPad', 'rocketpd' ) ) ); ?></p>
			<h1><?php echo esc_html( rocketpd_lp_get_field( 'hero_h1', __( 'LaunchPad', 'rocketpd' ) ) ); ?></h1>
			<p class="rpd-lp-hero__subhead"><?php echo esc_html( rocketpd_lp_get_field( 'hero_subhead', __( 'The Professional Learning System for Educator Growth', 'rocketpd' ) ) ); ?></p>
			<p class="rpd-lp-hero__body"><?php echo esc_html( rocketpd_lp_get_field( 'hero_body', __( 'LaunchPad helps districts move beyond disconnected professional development — giving teams one place to access high-quality learning, support educator growth, and turn professional learning into meaningful outcomes.', 'rocketpd' ) ) ); ?></p>
		...
		<div class="rpd-lp-hero__visual" aria-label="<?php esc_attr_e( 'LaunchPad dashboard preview', 'rocketpd' ); ?>">
			...
			<div class="rpd-lp-browser">
				<div class="rpd-lp-browser__bar"><span></span><span></span><span></span><b><?php echo esc_html( rocketpd_lp_get_field( 'hero_url_chip', 'app.rocketpd.com/dashboard' ) ); ?></b></div>
