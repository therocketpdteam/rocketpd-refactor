...
<section class="rpd-lp-section rpd-lp-instructors">
	<div class="rpd-container">
		<header class="rpd-lp-instructors__header"><div><p class="rpd-lp-eyebrow"><?php echo esc_html( rocketpd_lp_get_field( 'instructors_eyebrow', __( 'Meet Your Instructors', 'rocketpd' ) ) ); ?></p><h2><?php echo esc_html( rocketpd_lp_get_field( 'instructors_h2', __( "Learn from K–12's Most Trusted Voices.", 'rocketpd' ) ) ); ?></h2><p><?php echo esc_html( rocketpd_lp_get_field( 'instructors_intro', __( 'Every LaunchPad course is led by a nationally recognized educator, author, or K–12 leader — so your team learns from the voices already shaping the field.', 'rocketpd' ) ) ); ?></p></div><a href="<?php echo esc_url( $all['url'] ?? home_url( '/instructors/' ) ); ?>"><?php echo esc_html( $all['title'] ?? __( 'See all instructors', 'rocketpd' ) ); ?> →</a></header>
