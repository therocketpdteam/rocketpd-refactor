...
<section class="rpd-lp-section rpd-lp-product" id="explore">
	<div class="rpd-container rpd-lp-split rpd-lp-split--wide">
		...
		<div class="rpd-lp-ui-collage" aria-label="<?php esc_attr_e( 'LaunchPad product interface collage', 'rocketpd' ); ?>">
			...
			<div class="rpd-lp-ui rpd-lp-ui--course"><div class="rpd-lp-video-thumb"><?php rocketpd_lp_icon( 'play' ); ?><span>0%</span></div><small><?php esc_html_e( 'Course Card', 'rocketpd' ); ?></small><strong><?php esc_html_e( 'Closing Learning Gaps with Beth Estill', 'rocketpd' ); ?></strong><em><?php esc_html_e( '5 modules · 1 hr', 'rocketpd' ); ?></em><a href="#explore"><?php esc_html_e( 'Start Course →', 'rocketpd' ); ?></a></div>
