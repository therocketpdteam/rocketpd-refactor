...
$headline = rocketpd_get_field( 'rpd_about_focus_headline', __( 'At RocketPD, we focus on three things:', 'rocketpd' ) );
$cards    = rocketpd_get_field(
	'rpd_about_focus_cards',
	array(
		array(
			'icon'  => 'community',
...
<section class="rpd-about-focus rpd-about-section rpd-about-band">
	<div class="rpd-container">
		<h2 class="rpd-about-section-title"><?php echo esc_html( $headline ); ?></h2>
				...
				<?php foreach ( $cards as $card ) : ?>
					...
					<?php if ( $title || $body ) : ?>
						<article class="rpd-about-focus-card">
							<span class="rpd-about-icon rpd-about-icon--<?php echo esc_attr( sanitize_html_class( $icon ) ); ?>" aria-hidden="true"></span>
							<?php if ( $title ) : ?>
