	...
	<div class="rpd-container">
		...
		<?php if ( $guide ) : ?>
			<article class="rpd-course-featured-guide">
				<div>
					<p class="rpd-course-featured-guide__badge"><span aria-hidden="true"><?php echo rocketpd_get_icon( 'book-open', 14 ); ?></span><?php esc_html_e( 'Featured Free Guide', 'rocketpd' ); ?></p>
