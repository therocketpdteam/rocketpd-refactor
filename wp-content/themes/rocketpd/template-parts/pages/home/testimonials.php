...
$mode = rocketpd_get_field( 'rpd_home_testimonials_mode', 'defaults' );

if ( 'hidden' === $mode ) {
	return;
}

$default_headline     = __( 'Hear from the Community', 'rocketpd' );
...
if ( 'custom' === $mode ) {
	$headline     = rocketpd_get_field( 'rpd_home_testimonials_headline', $default_headline );
	$testimonials = rocketpd_get_field( 'rpd_home_testimonials', $default_testimonials );
	...
	$testimonials = $testimonials ? $testimonials : $default_testimonials;
} else {
