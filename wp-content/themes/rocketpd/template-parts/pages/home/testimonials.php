	...
	<div class="rpd-container">
		...
		<div class="rpd-home-card-grid rpd-home-card-grid--three">
			<?php foreach ( $testimonials as $testimonial ) : ?>
				<article class="rpd-home-testimonial rpd-home-testimonial--<?php echo esc_attr( sanitize_html_class( $testimonial['accent'] ?? 'purple' ) ); ?>">
					<span class="rpd-home-quote" aria-hidden="true">"</span>
					<blockquote><?php echo esc_html( $testimonial['quote'] ); ?></blockquote>
					<footer>
						<span><?php echo esc_html( $testimonial['initials'] ?? '' ); ?></span>
						<div>
